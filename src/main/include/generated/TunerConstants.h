...
public:
    ...
    // This needs to be tuned to your individual robot
    static constexpr units::meters_per_second_t kSpeedAt12Volts = 4.99_mps;

    // Every 1 rotation of the azimuth results in kCoupleRatio drive motor turns;
    // This may need to be tuned to your individual robot
    static constexpr units::scalar_t kCoupleRatio = 4.5;

    static constexpr units::scalar_t kDriveGearRatio = 6.394736842105262;
...
private:
    ...
    static constexpr units::inch_t kTrackWidth = 20.75_in;
    static constexpr units::inch_t kWheelBase = 24_in;
    ...
    static constexpr units::turn_t kFrontLeftEncoderOffset = 0.81413_tr;
    static constexpr bool kFrontLeftSteerMotorInverted = true;
    static constexpr bool kFrontLeftEncoderInverted = false;

    static constexpr units::inch_t kFrontLeftXPos = kWheelBase / 2;
    static constexpr units::inch_t kFrontLeftYPos = kTrackWidth / 2;
    ...
    static constexpr units::turn_t kFrontRightEncoderOffset = 0.6887207031_tr;
    static constexpr bool kFrontRightSteerMotorInverted = true;
    static constexpr bool kFrontRightEncoderInverted = false;

    static constexpr units::inch_t kFrontRightXPos = kWheelBase / 2;
    static constexpr units::inch_t kFrontRightYPos = -kTrackWidth / 2;
    ...
    static constexpr units::turn_t kBackLeftEncoderOffset = 0.464698_tr;
    static constexpr bool kBackLeftSteerMotorInverted = true;
    static constexpr bool kBackLeftEncoderInverted = false;

    static constexpr units::inch_t kBackLeftXPos = -kWheelBase / 2;
    static constexpr units::inch_t kBackLeftYPos = kTrackWidth / 2;
    ...
    static constexpr units::turn_t kBackRightEncoderOffset = -0.13406_tr;
    static constexpr bool kBackRightSteerMotorInverted = true;
    static constexpr bool kBackRightEncoderInverted = false;

    static constexpr units::inch_t kBackRightXPos = -kWheelBase / 2;
    static constexpr units::inch_t kBackRightYPos = -kTrackWidth / 2;
