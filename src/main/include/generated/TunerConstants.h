...
class TunerConstants {
    ...
    static constexpr configs::Slot0Configs steerGains = configs::Slot0Configs{}
        .WithKP(100).WithKI(0).WithKD(0.75)
        .WithKS(0.1).WithKV(1.40).WithKA(0.05)
    ...
    static constexpr units::ampere_t kSlipCurrent = 1000_A;
...
public:
    ...
    // This needs to be tuned to your individual robot
    static constexpr units::meters_per_second_t kSpeedAt12Volts = 6.19_mps;

private:
    // Every 1 rotation of the azimuth results in kCoupleRatio drive motor turns;
    // This may need to be tuned to your individual robot
    static constexpr units::scalar_t kCoupleRatio = 4.91;

    static constexpr units::scalar_t kDriveGearRatio = 5.1545;
    static constexpr units::scalar_t kSteerGearRatio = 12.1;
    static constexpr units::inch_t kWheelRadius = 1.875_in;
...
private:
    ...
    static constexpr units::turn_t kFrontLeftEncoderOffset = 0.2034_tr;
    static constexpr bool kFrontLeftSteerMotorInverted = true;
    static constexpr bool kFrontLeftEncoderInverted = false;

    static constexpr units::inch_t kFrontLeftXPos = 17.75_in / 2;
    static constexpr units::inch_t kFrontLeftYPos = 23.75_in / 2;
    ...
    static constexpr units::turn_t kFrontRightEncoderOffset = -0.093_tr;
    static constexpr bool kFrontRightSteerMotorInverted = true;
    static constexpr bool kFrontRightEncoderInverted = false;

    static constexpr units::inch_t kFrontRightXPos = 17.75_in / 2;
    static constexpr units::inch_t kFrontRightYPos = -23.75_in / 2;
    ...
    static constexpr units::turn_t kBackLeftEncoderOffset = -0.0225_tr;
    static constexpr bool kBackLeftSteerMotorInverted = true;
    static constexpr bool kBackLeftEncoderInverted = false;

    static constexpr units::inch_t kBackLeftXPos = -17.75_in / 2;
    static constexpr units::inch_t kBackLeftYPos = 23.75_in / 2;

    // Back Right
    static constexpr int kBackRightDriveMotorId = 7;
    static constexpr int kBackRightSteerMotorId = 8;
    static constexpr int kBackRightEncoderId = 4;
    static constexpr units::turn_t kBackRightEncoderOffset = -0.75_tr;
    static constexpr bool kBackRightSteerMotorInverted = true;
    static constexpr bool kBackRightEncoderInverted = false;

    static constexpr units::inch_t kBackRightXPos = -17.75_in / 2;
    static constexpr units::inch_t kBackRightYPos = -23.75_in / 2;
